...
!function(app){"use strict";app.registerModule("blurbs")}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("boards")}(ApplicationConfiguration);
...
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Blurbs",state:"blurbs",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","blurbs",{title:"List Blurbs",state:"blurbs.list"}),Menus.addSubMenuItem("topbar","blurbs",{title:"Create Blurb",state:"blurbs.create",roles:["user"]}),Menus.addSubMenuItem("topbar","blurbs",{title:"About",state:"blurbs.about"})}angular.module("blurbs").run(menuConfig),menuConfig.$inject=["Menus"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("blurbs",{"abstract":!0,url:"/blurbs",template:"<ui-view/>"}).state("blurbs.list",{url:"",templateUrl:"modules/blurbs/client/views/list-blurbs.client.view.html",controller:"BlurbsListController",controllerAs:"vm",data:{pageTitle:"Blurbs List"}}).state("blurbs.create",{url:"/create",templateUrl:"modules/blurbs/client/views/form-blurb.client.view.html",controller:"BlurbsController",controllerAs:"vm",resolve:{blurbResolve:newBlurb},data:{roles:["user","admin"],pageTitle:"Blurbs Create"}}).state("blurbs.edit",{url:"/:blurbId/edit",templateUrl:"modules/blurbs/client/views/form-blurb.client.view.html",controller:"BlurbsController",controllerAs:"vm",resolve:{blurbResolve:getBlurb},data:{roles:["user","admin"],pageTitle:"Edit Blurb {{ blurbResolve.name }}"}}).state("blurbs.view",{url:"/:blurbId",templateUrl:"modules/blurbs/client/views/view-blurb.client.view.html",controller:"BlurbsController",controllerAs:"vm",resolve:{blurbResolve:getBlurb},data:{pageTitle:"Blurb {{ blurbResolve.name }}"}}).state("blurbs.boards",{url:"/boards",templateUrl:"modules/blurbs/client/views/boards/blurb-boards.html",controller:"BlurbBoards",controllerAs:"vm",data:{pageTitle:"Boards"}}).state("blurbs.about",{url:"/about",templateUrl:"modules/blurbs/client/views/profile/blurb-profile.html",controller:"BlurbProfile",controllerAs:"vm",data:{pageTitle:"About"}})}function getBlurb($stateParams,BlurbsService){return BlurbsService.get({blurbId:$stateParams.blurbId}).$promise}function newBlurb(BlurbsService){return new BlurbsService}angular.module("blurbs").config(routeConfig),routeConfig.$inject=["$stateProvider"],getBlurb.$inject=["$stateParams","BlurbsService"],newBlurb.$inject=["BlurbsService"]}();
!function(){"use strict";function BlurbsController($scope,$state,$window,Authentication,blurb){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.blurb.$remove($state.go("blurbs.list"))}function save(isValid){function successCallback(res){$state.go("blurbs.view",{blurbId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.blurb._id?vm.blurb.$update(successCallback,errorCallback):vm.blurb.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.blurbForm"),!1)}var vm=this;vm.authentication=Authentication,vm.blurb=blurb,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("blurbs").controller("BlurbsController",BlurbsController),BlurbsController.$inject=["$scope","$state","$window","Authentication","blurbResolve"]}();
!function(){"use strict";function BlurbsListController(BlurbsService){var vm=this;vm.blurbs=BlurbsService.query()}angular.module("blurbs").controller("BlurbsListController",BlurbsListController),BlurbsListController.$inject=["BlurbsService"]}();
!function(){"use strict";function BlurbsService($resource){return $resource("api/blurbs/:blurbId",{blurbId:"@_id"},{update:{method:"PUT"}})}angular.module("blurbs").factory("BlurbsService",BlurbsService),BlurbsService.$inject=["$resource"]}();
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Boards",state:"boards",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","boards",{title:"List Boards",state:"boards.list"}),Menus.addSubMenuItem("topbar","boards",{title:"Create Board",state:"boards.create",roles:["user"]})}angular.module("boards").run(menuConfig),menuConfig.$inject=["Menus"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("boards",{"abstract":!0,url:"/boards",template:"<ui-view/>"}).state("boards.list",{url:"",templateUrl:"modules/boards/client/views/list-boards.client.view.html",controller:"BoardsListController",controllerAs:"vm",data:{pageTitle:"Boards List"}}).state("boards.create",{url:"/create",templateUrl:"modules/boards/client/views/form-board.client.view.html",controller:"BoardsController",controllerAs:"vm",resolve:{boardResolve:newBoard},data:{roles:["user","admin"],pageTitle:"Boards Create"}}).state("boards.edit",{url:"/:boardId/edit",templateUrl:"modules/boards/client/views/form-board.client.view.html",controller:"BoardsController",controllerAs:"vm",resolve:{boardResolve:getBoard},data:{roles:["user","admin"],pageTitle:"Edit Board {{ boardResolve.name }}"}}).state("boards.addblurb",{title:"Add Blurb",state:"blurbs.add",roles:["user"]}).state("boards.view",{url:"/:boardId",templateUrl:"modules/boards/client/views/view-board.client.view.html",controller:"BoardsController",controllerAs:"vm",resolve:{boardResolve:getBoard},data:{pageTitle:"Board {{ boardResolve.name }}"}})}function getBoard($stateParams,BoardsService){return BoardsService.get({boardId:$stateParams.boardId}).$promise}function newBoard(BoardsService){return new BoardsService}angular.module("boards").config(routeConfig),routeConfig.$inject=["$stateProvider"],getBoard.$inject=["$stateParams","BoardsService"],newBoard.$inject=["BoardsService"]}();
!function(){"use strict";function BoardsController($scope,$state,$window,Authentication,board){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.board.$remove($state.go("boards.list"))}function save(isValid){function successCallback(res){$state.go("boards.view",{boardId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.board._id?vm.board.$update(successCallback,errorCallback):vm.board.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.boardForm"),!1)}var vm=this;vm.authentication=Authentication,vm.board=board,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("boards").controller("BoardsController",BoardsController),BoardsController.$inject=["$scope","$state","$window","Authentication","boardResolve"]}();
!function(){"use strict";function BoardsListController(BoardsService){var vm=this;vm.boards=BoardsService.query()}angular.module("boards").controller("BoardsListController",BoardsListController),BoardsListController.$inject=["BoardsService"]}();
!function(){"use strict";function BoardsService($resource){return $resource("api/boards/:boardId",{boardId:"@_id"},{update:{method:"PUT"}})}angular.module("boards").factory("BoardsService",BoardsService),BoardsService.$inject=["$resource"]}();
